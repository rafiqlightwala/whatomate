...
func (a *App) sendAndSaveInteractiveButtonsWithDelayRange(account *models.WhatsAppAccount, contact *models.Contact, bodyText string, buttons []map[string]any, minSec, maxSec int) error {
	if minSec > 0 || maxSec > 0 {
		a.applyChatbotReplyDelayRangeForContact(account, contact, minSec, maxSec)
	} else {
		a.applyChatbotReplyDelayForContact(account, contact)
...
func (a *App) sendAndSaveInteractiveButtonsRaw(account *models.WhatsAppAccount, contact *models.Contact, bodyText string, buttons []map[string]any) error {
